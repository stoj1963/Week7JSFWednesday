...
public class AddressRegistrationJSFBean implements Serializable {
	...
	public String getInput() {
		return "<p style=\"color:red\">You entered <br />" + "Last Name: "
				+ lastName + "<br />" + "First Name: " + firstName + "<br />"
				+ "MI: " + mi + "<br />" + "Telephone: " + telephone + "<br />"
				+ "Email: " + email + "<br />" + "Street: " + street + "<br />"
	...
	private void initializeJdbc() {
		try {
			...
			Connection conn = DriverManager.getConnection(
					"jdbc:mysql://localhost/test", "john", "john");
